    ...
    <Container>
      <Row>
        ...
        >
          ...
          <Form.Select multiple aria-label="Default select example" style={selectStyle} onChange={(e) => setFilterSources([].slice.call(e.target.selectedOptions).map((item) => item.value))}>
